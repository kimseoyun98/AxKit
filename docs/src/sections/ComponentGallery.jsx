    ...
    <div style={{ display: 'flex', flexDirection: 'column', gap: 28, width: '100%', maxWidth: 480, margin: '0 auto' }}>
      ...
      <div style={{ display: 'flex', flexDirection: 'column', gap: 12, width: '100%', alignItems: 'center' }}>
        ...
        <div style={{ display: 'flex', flexWrap: 'wrap', gap: 8, justifyContent: 'center', alignItems: 'center' }}>
          <ActionButton variant="brandSolid" size="medium" prefixIcon={<IconAddRegular style={{ width: 16, height: 16 }} />}>
            글쓰기
          </ActionButton>
          <ActionButton variant="neutralWeak" size="medium" suffixIcon={<IconChevronRightRegular style={{ width: 16, height: 16 }} />}>
            더보기
          </ActionButton>
          <ActionButton variant="neutralOutline" size="medium" layout="iconOnly" aria-label="관심">
            <IconHeartRegular style={{ width: 18, height: 18 }} />
          </ActionButton>
