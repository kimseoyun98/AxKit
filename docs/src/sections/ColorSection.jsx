...
export function ColorSection() {
  ...
  const staticBlack = [
    ...
    { name: 'static-black-alpha-100', hex: '#00000007' },
    { name: 'static-black-alpha-200', hex: '#0000000C' },
    { name: 'static-black-alpha-300', hex: '#00000010' },
    { name: 'static-black-alpha-400', hex: '#00000021' },
    { name: 'static-black-alpha-500', hex: '#0000002C' },
    { name: 'static-black-alpha-600', hex: '#0000004C' },
    { name: 'static-black-alpha-700', hex: '#00000074' },
    { name: 'static-black-alpha-800', hex: '#000000A2' },
    { name: 'static-black-alpha-900', hex: '#000000D0' },
    { name: 'static-black-alpha-1000', hex: '#000000E3' },
  ]
  const staticWhite = [
    { name: 'static-white', hex: '#FFFFFF', border: true },
    { name: 'static-white-alpha-50', hex: '#FFFFFF0D', border: true },
    { name: 'static-white-alpha-100', hex: '#FFFFFF17', border: true },
    { name: 'static-white-alpha-200', hex: '#FFFFFF20', border: true },
    { name: 'static-white-alpha-300', hex: '#FFFFFF2E', border: true },
    { name: 'static-white-alpha-400', hex: '#FFFFFF3D', border: true },
    { name: 'static-white-alpha-500', hex: '#FFFFFF60', border: true },
    { name: 'static-white-alpha-600', hex: '#FFFFFF8B', border: true },
    { name: 'static-white-alpha-700', hex: '#FFFFFFB3', border: true },
    { name: 'static-white-alpha-800', hex: '#FFFFFFDE', border: true },
    { name: 'static-white-alpha-900', hex: '#FFFFFFEA', border: true },
    { name: 'static-white-alpha-1000', hex: '#FFFFFFF4', border: true },
  ]
