...
(async function createActionButtonComponentSet() {
  ...
  "styleMapping": {
    "brandSolid": {
      "bg": "--seed-color-bg-brand-solid",
      "fg": "--seed-color-fg-neutral-inverted"
    },
    "neutralSolid": {
      "bg": "--seed-color-bg-neutral-solid",
      "fg": "--seed-color-fg-neutral-inverted"
    },
    "neutralWeak": {
      "bg": "--seed-color-bg-neutral-weak",
      "fg": "--seed-color-fg-neutral"
    },
    "neutralOutline": {
      "bg": "--seed-color-bg-layer-default",
      "fg": "--seed-color-fg-neutral",
      "border": "--seed-color-stroke-neutral-weak"
    },
    "criticalSolid": {
      "bg": "--seed-color-bg-critical-solid",
      "fg": "--seed-color-fg-neutral-inverted"
    },
    "criticalWeak": {
      "bg": "--seed-color-bg-critical-weak",
      "fg": "--seed-color-fg-critical"
    }
  },
  "sizeMapping": {
    "large": {
